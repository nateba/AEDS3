...
public class BaseString {
    ...
    // public static StringBuilder gerarStringBaseComprimida(int versaoArquivo)
    // throws Exception {
    // // Abrir o arquivo ANIMES.DB somente para leitura
    // RandomAccessFile arq = new
    // RandomAccessFile("compressao/animesHuffmanCompressao" + versaoArquivo +
    // ".db", "r");

    // long ponteiroBase = arq.getFilePointer(); // Pegar o endereço do ponteiro de
    // início
    ...
    // // Fazer o teste para o caso de haver um arquivo com numero de bits múltiplos
    // de
